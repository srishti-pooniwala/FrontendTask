    ...
    <>
        ...
        <Modal show={show} fullscreen={fullscreen} onHide={handleHideModal} keyboard={false} >
            <Modal.Header closeButton className='modalHeader'>
                <Modal.Title>Assign Task Phases</Modal.Title>
            </Modal.Header>
            <Modal.Body className='modalBodyStatic'>
                ...
                <p>Click on mentioned task phases to assign a phase to a member.</p>
                <p><b>Task Title:  {projectData.currentProject.projectTitle} </b></p>
                <br></br>
                <Container>
                    <p><b>Task Phases :-</b></p>
                    <Row>
                ...
                :
                <>
                <p className='warningTxt'>Selected task will be permanently deleted when click on <b>Delete Task</b> button.</p>
                <ListGroup>
