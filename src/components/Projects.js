  ...
  return (
    <>
            ...
            <Form method='POST' onSubmit={handleSubmit} className='contactForm' name='projectForm' id='projectForm'>
                ...
                <Row>
                    ...
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control type="text" name='projectTitle' className='formInput' id='projectTitle' value={projectDetails.projectTitle} onChange={handleInputs} placeholder="Enter Task Title" />
                    </Form.Group>
                    </Col>
                    <Col>
                ...
                <Row>
                    <Col>
                        <Form.Label>Add Task Phases</Form.Label><Button className="addMembers" onClick={()=>setPhaseModal(true)}><i className="fa fa-plus"></i></Button>
      ...
      <Modal size="sm" show={smShow} onHide={() => setSmShow(false)} aria-labelledby="example-modal-sizes-title-sm">
            ...
            <Modal.Body className='modalBody'>
                <Container>
                    <p>You can only add 1 to 10 phases per task.</p>
